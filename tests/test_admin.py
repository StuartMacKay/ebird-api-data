...
from ebird.api.data import models
...
# a live database and deleting Country, County, Location or State,
# will trigger generating a list of all Checklists and all Observations,
